...
type ArticleRepo interface {
	CreateArticle(context.Context, *article_protos.CreateArticleRequest) (*article_protos.CreateArticleResponse, error)
	UpdateArticle(context.Context, *article_protos.UpdateArticleRequest) (*article_protos.UpdateArticleResponse, error)
	RewriteArticle(context.Context, *article_protos.RewriteArticleRequest) (*article_protos.RewriteArticleResponse, error)
